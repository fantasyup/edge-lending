...
interface MockDistributorManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockDistributorManager extends Contract {
  ...
  interface: MockDistributorManagerInterface;
