...
contract VaultStorageLayoutTester is Vault {
    ...
    function validateStorageLayout() external pure {
        ...
        require(slot == 3 && offset == 0, "flashloan rate has changed location");
        ...
        require(slot == 5 && offset == 0, "owner has changed location");
        ...
        require(slot == 7 && offset == 0, "totals has changed location");
        ...
        require(slot == 9 && offset == 0, "userApprovedContracts rate has changed location");
    }
}
