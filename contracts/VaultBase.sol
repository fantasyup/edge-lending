...
abstract contract VaultBase is UUPSProxiableAndPausable, IBSVault {
    ...
    uint256 constant public MAX_FLASHLOAN_RATE = 1 * 10**17;
    ...
    bytes32 internal constant _VAULT_APPROVAL_SIGNATURE_TYPE_HASH =
        keccak256("VaultAccessApproval(string warning,address user,address contract,bool approved,uint256 nonce)");
